return {
  ...
  config = function()
    ...
    lsp.on_attach(function(client, bufnr)
      ...
      vim.keymap.set("n", "gr", function() vim.lsp.buf.references() end, vim.tbl_deep_extend("force", opts, { desc = "LSP References" }))
      ...
      vim.keymap.set("n", "<leader>lr", function() vim.lsp.buf.rename() end, vim.tbl_deep_extend("force", opts, { desc = "LSP Rename" }))
